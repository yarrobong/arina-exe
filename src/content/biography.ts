...
export const eras: Era[] = [
  ...
  },
  {
    ...
    song: {
      ...
      artist: 'Пошлая Молли',
      src: '/media/audio/poshlaya-molly-samyy-luchshiy-emo-punk.mp3',
    },
  },
  {
    id: 'school-10-11',
  ...
  },
  {
    ...
    photos: [
      { src: '/media/urfu/year-2.webm', alt: 'Арина на втором курсе УрФУ в движении', caption: 'Второй курс', date: 'сентябрь 2026' },
    ],
    song: {
      title: 'MISS U',
      artist: 'AQUAKEY',
